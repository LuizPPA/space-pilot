...
public class PlayerControl : MonoBehaviour
{
    ...
    {
        var cameraPositionController = Camera.main.GetComponent<AttachPositionToObject>();
        cameraPositionController.SetEnabled(false);
        transitioning = true;
        for(int i = 0; (Camera.main.transform.localEulerAngles != Vector3.zero && i < 100); i++)
        {
        ...
        cameraPositionController.SetEnabled(true);
        transitioning = false;
    }
}
